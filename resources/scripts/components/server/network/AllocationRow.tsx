...
const Label = styled.label`
    ${tw`uppercase text-xs mt-1 text-dactyl-purple2 block px-1 select-none transition-colors duration-150`}
`;
    ...
    return (
        <GreyRowBox $hoverable={false} className={'flex-wrap md:flex-nowrap mt-2'}>
            <div className={'flex items-center w-full md:w-auto'}>
                <div className={'mx-6 p-2 border-4 border-dactyl-orange2 rounded-full text-neutral-400'}>
                    <FontAwesomeIcon icon={faNetworkWired} style={{ width: '22px', height: '22px' }}/>
                </div>
