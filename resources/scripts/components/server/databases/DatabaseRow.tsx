...
import { faDatabase, faEye, faLink, faTrashAlt } from '@fortawesome/free-solid-svg-icons';
    ...
    return (
        <>
            <Formik onSubmit={submit} initialValues={{ confirm: '' }} validationSchema={schema} isInitialValid={false}>
                {({ isSubmitting, isValid, resetForm }) => (
                    ...
                    >
                        ...
                        <h2 css={tw`text-2xl mb-6 text-dactyl-purple2`}>Confirm database deletion</h2>
            ...
            <Modal visible={connectionVisible} onDismissed={() => setConnectionVisible(false)}>
                ...
                <h3 css={tw`mb-6 text-2xl text-dactyl-purple2`}>Database connection details</h3>
                <div>
            ...
            <GreyRowBox $hoverable={false} className={className} css={tw`mb-2`}>
                <div css={tw`border-4 border-dactyl-orange2 rounded-full p-2 hidden md:block`}>
                    <FontAwesomeIcon icon={faDatabase} style={{ width: '16px', height: '16px' }} />
                </div>
                <div css={tw`flex-1 ml-4`}>
                    <CopyOnClick text={database.name}>
                        <p css={tw`text-base text-dactyl-purple2`}>{database.name}</p>
                    </CopyOnClick>
                </div>
                ...
                <div css={tw`ml-8`}>
                    ...
                    <a rel="noreferrer" href={`https://${database.host}`} target='_blank'>
                        <Button color={'green'} css={tw`mr-3 px-3 py-3`}>
                            <FontAwesomeIcon icon={faLink} style={{ width: '16px', height: '16px' }}/>
                        </Button>
                    </a>
