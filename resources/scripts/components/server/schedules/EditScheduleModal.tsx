...
const EditScheduleModal = ({ schedule }: Props) => {
    ...
    return (
        ...
        >
            {({ isSubmitting }) => (
                <Form>
                    <h3 css={tw`text-2xl mb-6 text-dactyl-purple2`}>{schedule ? 'Edit schedule' : 'Create new schedule'}</h3>
                    ...
                    <div css={tw`mt-6 bg-dactyl-white2 shadow-lg p-4 rounded-2xl`}>
                        <Switch
                    ...
                    <div css={tw`mt-6 text-right`}>
                        <Button className={'w-full sm:w-auto'} type={'submit'} disabled={isSubmitting}>
                            <FontAwesomeIcon icon={faPlay} css={tw`mr-1`} />
