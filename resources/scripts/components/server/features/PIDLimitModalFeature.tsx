            ...
            {isAdmin ? (
                <>
                    <div css={tw`mt-4 sm:flex items-center`}>
                        ...
                        <h2 css={tw`text-2xl mb-4 text-neutral-600`}>Memory or process limit reached...</h2>
                    </div>
                    <p css={tw`mt-4 text-neutral-400`}>This server has reached the maximum process or memory limit.</p>
                    <p css={tw`mt-4 text-neutral-400`}>
