...
const ServerResult = styled(Link)`
    ${tw`flex items-center bg-white p-4 rounded-2xl shadow-md border-l-4 border-yellow-400 no-underline transition-all duration-150`};

    &:hover {
        ${tw`shadow-lg border-yellow-500`};
    }
                            ...
                            {servers.map((server) => (
                                ...
                                >
                                    ...
                                    <div css={tw`flex-none text-right`}>
                                        <span css={tw`text-xs py-1 px-2 bg-cyan-500 text-cyan-100 rounded-2xl`}>
                                            {server.node}
                                        </span>
                                    </div>
                                </ServerResult>
